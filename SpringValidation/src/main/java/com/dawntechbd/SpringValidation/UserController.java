...
public class UserController {
    ...
    //private static String UPLOADED_FOLDER = "images/"; //Okay when images folder is at project root (F://1246913/Spring/SpringValidation/)
    ...
    public String save(@Valid User user, BindingResult bindingResult, Model model, @RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            model.addAttribute("roleList", this.roleRepo.findAll());
            model.addAttribute("successMsg", "Congratulations ! User Saved.");
